...
<body>
    ...
    <!--navbar-->
    <nav class="navbar fixed-top navbar-expand-lg bg-pink" data-bs-theme="dark">
        <!--container-->
        <div class="container py-2 px-4">
            <!--navbar brand-->
                ...
                <!--offcanvas-->
                <div class="offcanvas offcanvas-end bg-pink" id="offcanvasNavbar">
                    <!-- offcanvas Header  -->
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item activr bg-pink" type="button">
                                        <small>Latest (5.3.x) <i class="bi-check"></i></small></button></li>
                        ...
                        <div class="dropdown" data-bs-theme="light">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><button class="dropdown-item active bg-pink" type="button">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <p class="fs-5 mt-3">Quickly design and costomize responsive
                        mobile-first sites with Bootstrap, the world's most popular front-ed open source
                        toolkit, featuring Sass variables and mixind, responsive grid system, extensive
                        prebuilt components, and powerfu JavaScript plugins.
                    </p>
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            <button type="button" class="btn bg-pink text-white btn-lg mb-3 me-md-3 px-4 py-3">Get Started</button>
                ...
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in world by the
                            <a href="">Bootstrap Team</a>with the help of <a href="" class="text-black">our contributors</a></small>
                    </div>
                    <div class="mt-2 text-muted">
...
<?php /**PATH C:\Users\LENOVO\Praktikum3\resources\views/routing.blade.php ENDPATH**/ ?>